...
class OwnerEditBookingForm(forms.ModelForm):
    class Meta:
        model=Booking
        fields = "__all__"
        exclude=("room","guest","guest_name","stay_start_date","stay_end_date","total_bookingss","guest_mobile","no_of_days","total","occupancy_adult","occupancy_child")
...
class PerDayBookingEditForm(forms.ModelForm):
    class Meta:
        model=PerDayBooking
        fields="__all__"
